...
data class ContactSearchRequest(
  ...
  @field:Pattern(regexp = "^[a-zA-Z\\s,.'-]*$", message = "Special characters are not allowed for Last Name.")
  ...
  @field:Pattern(regexp = "^[a-zA-Z\\s,.'-]*$", message = "Special characters are not allowed for First Name.")
  val firstName: String?,

  @Schema(description = "Middle name of the contact", example = "Simon", nullable = true, maxLength = 12)
  @field:Pattern(regexp = "^[a-zA-Z\\s,.'-]*$", message = "Special characters are not allowed for Middle Name.")
