...
class MigrationServiceTest {
  ...
  inner class MigrationExtractFromRequest {
    ...
    @Test
    fun `should extract and pair IDs for a valid contact`() {
    ...
    @Test
    fun `should extract and pair IDs for contact phone numbers`() {
      val auditInfo = migrateAuditInfo()
  ...
  @Test
  fun `should extract and pair IDs for contact identifiers`() {
    val auditInfo = migrateAuditInfo()
