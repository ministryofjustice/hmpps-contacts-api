alter table contact alter column contact_id restart with 16;

alter table contact_address alter column contact_address_id restart with 16;
...
alter table reference_codes alter column reference_code_id restart with 82;
